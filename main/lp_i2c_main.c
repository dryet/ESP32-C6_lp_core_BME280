...
static void lp_core_init(void) {
	...
	ulp_lp_core_cfg_t cfg = { .wakeup_source =
	ULP_LP_CORE_WAKEUP_SOURCE_LP_TIMER, .lp_timer_sleep_duration_us = 1000000, };

	ret = ulp_lp_core_load_binary(lp_core_main_bin_start,
